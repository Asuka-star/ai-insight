...
- 范围确认阶段负责把自然语言需求转成竞品分析工单，并生成待确认范围。
...
- 主流程节点顺序为 Researcher、Extractor、Analyst、Writer、Reviewer，Reviewer 通过后流程结束。
...
3. 点击“导出调研问卷”，说明 TXT 会按腾讯问卷内容 DSL 生成题干和选项，可粘贴到腾讯问卷建题。
4. 展示“导入调研数据”和“结果回收”区域，说明 CSV/XLSX 导入后会转成问卷证据和结构化洞察。
